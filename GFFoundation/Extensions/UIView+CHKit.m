...
- (void)setDefaultDarkModel {
    [self setDarkModelColor:UIColor.blackColor lightModelColor:UIColor.whiteColor];
}

- (void)setDarkModelColor:(UIColor *)darkModelColor lightModelColor:(UIColor *)lightModelColor {
    if (@available(iOS 13.0, *)) {
        self.backgroundColor =  [UIColor colorWithDynamicProvider:^UIColor * _Nonnull(UITraitCollection * _Nonnull trait) {
           if (trait.userInterfaceStyle == UIUserInterfaceStyleDark) {
               return darkModelColor;
           } else {
